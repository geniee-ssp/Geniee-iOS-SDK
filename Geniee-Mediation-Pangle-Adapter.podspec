#
#  Be sure to run `pod spec lint Geniee-Mediation-Pangle-Adapter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "Geniee-Mediation-Pangle-Adapter"
  s.version      = "3.1.1"
  s.summary      = "An adapter SDK for integrating Pangle"
 ...
 s.source       = { :git => "https://github.com/geniee-ssp/Geniee-iOS-SDK.git", :branch => "feature/cocoapod_adnws" }
  ...
  #
  s.vendored_frameworks = "adnetwork-adapters/Framework/GenieeMediationPangle.xcframework"
