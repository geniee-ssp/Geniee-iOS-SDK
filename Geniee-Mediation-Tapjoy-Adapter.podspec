#
#  Be sure to run `pod spec lint Geniee-Mediation-Geniee-Mediation-Tapjoy-Adapter.podspec-Adapter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "Geniee-Mediation-Tapjoy-Adapter"
  s.version      = "3.1.1"
  s.summary      = "An adapter SDK for integrating Tapjoy"
 ...
 s.source       = { :git => "https://github.com/geniee-ssp/Geniee-iOS-SDK.git", :branch => "feature/cocoapod_adnws" }
  ...
  #
  s.vendored_frameworks = "adnetwork-adapters/Framework/GenieeMediationTapjoy.xcframework"
