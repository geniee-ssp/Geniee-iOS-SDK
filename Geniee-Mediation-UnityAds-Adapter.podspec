#
#  Be sure to run `pod spec lint Geniee-Mediation-UnityAds-Adapter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "Geniee-Mediation-UnityAds-Adapter"
  s.version      = "8.3.1.0"
  s.summary      = "An adapter SDK for integrating UnityAds"
 ...
 s.source       = { :git => "https://github.com/geniee-ssp/Geniee-iOS-SDK.git", :tag => "v.8.3.3" }
  ...
  #
  s.vendored_frameworks = "adnetwork-adapters/Framework/GenieeMediationUnityAds.xcframework"
