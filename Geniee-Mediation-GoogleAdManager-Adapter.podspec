#
#  Be sure to run `pod spec lint Geniee-Mediation-GoogleAdManager-Adapter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
 ...
 s.source       = { :git => "https://github.com/geniee-ssp/Geniee-iOS-SDK.git", :tag => "v.8.4.3" }
  ...
  #
  s.vendored_frameworks = "adnetwork-adapters/Framework/GenieeMediationGoogleAdManager.xcframework"
