#
#  Be sure to run `pod spec lint Geniee-Mediation-AppLovin-Adapter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "Geniee-Mediation-AppLovin-Adapter"
  s.version      = "8.3.1.0"
  s.summary      = "An adapter SDK for integrating AppLovin"
 ...
 s.source       = { :git => "https://github.com/geniee-ssp/Geniee-iOS-SDK.git", :tag => "v.8.3.3" }
  ...
  #
  s.vendored_frameworks = "adnetwork-adapters/Framework/GenieeMediationAppLovin.xcframework"
