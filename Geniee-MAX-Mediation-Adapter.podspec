#
#  Be sure to run `pod spec lint Geniee-MAX-Mediation-Adapter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
 ...
 s.source       = { :git => "https://github.com/geniee-ssp/Geniee-iOS-SDK.git", :tag => "v.8.3.5" }
  ...
  #
  s.vendored_frameworks = "GNAdMAXMediationAdapter/Framework/GNAdMAXMediationAdapter.xcframework"
