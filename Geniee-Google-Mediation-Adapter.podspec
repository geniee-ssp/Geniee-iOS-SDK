...
Pod::Spec.new do |s|
 ...
 s.source       = { :git => "https://github.com/geniee-ssp/Geniee-iOS-SDK.git", :tag => "v.8.2.4" }
  ...
  #
  s.vendored_frameworks = "GNAdGoogleMediationAdapter/Framework/GNAdGoogleMediationAdapter.xcframework"
