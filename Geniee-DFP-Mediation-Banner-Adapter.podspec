#
#  Be sure to run `pod spec lint Geniee-DFP-Mediation-Adapter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "Geniee-DFP-Mediation-Banner-Adapter"
  s.version      = "5.2.4"
 ...
 s.source       = { :git => "https://github.com/geniee-ssp/Geniee-iOS-SDK.git", :tag => "v.5.2.4" }
  ...
  #
  s.vendored_frameworks = "GNAdDFPBannerMediationAdapter/Framework/GNAdDFPBannerMediationAdapter.framework"
