...
@protocol GNAdCustomEventBanner;
...
@protocol GNAdCustomEventBannerDelegate<NSObject>

/// Your Custom Event object must call this when it receives or creates an ad view.
- (void)customEventBanner:(id<GNAdCustomEventBanner>)customEvent didReceiveAd:(UIView *)view;
...
- (void)customEventBanner:(id<GNAdCustomEventBanner>)customEvent didFailAd:(NSError *)error;
...
- (void)customEventBanner:(id<GNAdCustomEventBanner>)customEvent clickDidOccurInAd:(UIView *)view;
...
- (void)customEventBannerWillPresentModal:(id<GNAdCustomEventBanner>)customEvent;

/// Your Custom Event should call this when the user dismisses the modal view and the modal view is
/// about to go away.
- (void)customEventBannerWillDismissModal:(id<GNAdCustomEventBanner>)customEvent;

/// Your Custom Event should call this when the user dismisses the modal view and the modal view has
/// gone away.
- (void)customEventBannerDidDismissModal:(id<GNAdCustomEventBanner>)customEvent;

/// Your Custom Event should call this method when a user action will result in App switching.
- (void)customEventBannerWillLeaveApplication:(id<GNAdCustomEventBanner>)customEvent;
