...
class RewardVideoViewController: UIViewController, GNSRewardVideoAdDelegate {
    
    @IBOutlet weak var zoneIDText: UITextField!
    @IBOutlet weak var isRTBSwitch: UISwitch!
    ...
    @IBAction func onLoadRewardClicked(_ sender: Any) {
        ...
        GNSRewardVideoAd.sharedInstance()?.load(request, withZoneID: zoneIDText.text, isRTB: isRTBSwitch.isOn)
