...
#import "GoogleBannerViewController.h"

@interface GoogleBannerViewController() <GADBannerViewDelegate, UIPickerViewDelegate, UITextFieldDelegate>
...
@implementation GoogleBannerViewController {
...
- (void)setAdSizeArray {
    ...
    [adSizeArray addObject:@"Medium Rectangle"];     // 300x250
    [adSizeArray addObject:@"Large Banner"];              // 320x100
    [adSizeArray addObject:@"Invalid Size"];
}

- (GADAdSize)getAdSizeType:(int)index {
    GADAdSize adSizeType = GADAdSizeInvalid;
    switch (index) {
        case 0:
