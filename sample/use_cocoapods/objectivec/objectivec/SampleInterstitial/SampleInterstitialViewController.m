#import "SampleInterstitialViewController.h"
#import "UIView+Toast.h"

@interface SampleInterstitialViewController ()
{
    UIButton *loadbutton;
    UIButton *showbutton;
}
...
@implementation SampleInterstitialViewController
...
- (void)viewDidLoad {
    ...
    _interstitial = [[GNInterstitial alloc] initWithID:@"1393540"];
