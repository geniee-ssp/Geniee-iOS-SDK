#import "SampleVideoViewController.h"
#import "UIView+Toast.h"

@interface SampleVideoViewController ()
{
    UIButton *loadbutton;
    UIButton *showbutton;
}
...
@implementation SampleVideoViewController
...
- (void)viewDidLoad {
    ...
    _videoAd = [[GNAdVideo alloc] initWithID:@"1319731"];
...
- (void)showSampleButton {
    ...
    loadbutton.frame = CGRectMake((self.view.frame.size.width - 150)/2, 90, 150, 40);
    ...
    [showbutton setTitle:@"show video" forState:UIControlStateNormal];
    showbutton.titleLabel.font = [UIFont systemFontOfSize:14.0];
    showbutton.frame = CGRectMake((self.view.frame.size.width - 150)/2, 150, 150, 40);
